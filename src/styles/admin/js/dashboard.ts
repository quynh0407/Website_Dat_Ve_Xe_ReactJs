...
$(function () {
  // Kiểm tra và render chart nếu phần tử tồn tại
  ...
  if (chartElement) {
    ...
    console.error("⚠️ Element with ID '#chart' not found!");
  }

  // Kiểm tra và render earning chart nếu phần tử tồn tại
  ...
  if (earningElement) {
    ...
    new ApexCharts(earningElement, earningOptions).render();
  } else {
    console.error("⚠️ Element with ID '#earning' not found!");
  }
});
