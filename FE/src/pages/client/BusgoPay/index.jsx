            ...
            <main className="history mb-4 lg:mt-[12%] ">
                <div className="flex lg:w-[80%]  w-[90%] mx-auto lg:min-h-[30rem] ">
                    ...
                    <div className="lg:w-[80%] md:w-full  mobile:w-full bg-white p-3 rounded-md lg:ml-4 overflow-x-auto">
                        <div className="flex justify-between p-6 border-2 border-gray-200 bg-slate-200 rounded-md">
                            <span className="flex flex-col justify-center items-center">
                                <p>Số ví dư</p>
                                <h1 className="text-6xl text-orange-600">0 đ</h1>
                            </span>

                            <span className="flex flex-col justify-center items-center">
                                <img src="/assets/images/logos/clock.png" alt="" className="w-16 h-16" />
                                <p>Số ví dư</p>
                            </span>
                        </div>
                        <h1 className="text-2xl mt-5">Lịch sử giao dịch</h1>
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-3 mb-4">
                            ...
                            <div className="flex items-end">
                                <button className="w-full py-1 px-1 border-2 border-orange-600 text-orange-600 hover:bg-orange-700 rounded-xl">
                                    Tìm
                                </button>
                            </div>
                        </div>
